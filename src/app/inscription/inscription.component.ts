...
export class InscriptionComponent {
  ...
  action($name:any,$val?:any){
    ...
    if($name=='delete'){
      this.currentindex=$val;
      this.crud.delete(this.urlpost,this.listeleve[this.currentindex]._id).subscribe({
        next:(data:any)=>{
  ...
  update(){
    this.crud.put(this.urlpost,this.addeleveForm.value,this.listeleve[this.currentindex]._id).subscribe({
      next:(data:any)=>{
